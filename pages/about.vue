      ...
      <div class="max-w-4xl mx-auto mb-12">
        <div class="bg-white rounded-lg shadow-md p-8">
          ...
          <div class="flex flex-wrap gap-4 mt-6">
            ...
            <NuxtLink
              to="/"
              class="inline-flex items-center gap-2 px-4 py-2 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors whitespace-nowrap flex-shrink-0"
            >
