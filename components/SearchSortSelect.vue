<template>
  <div class="flex items-center gap-2">
    <span class="text-sm text-gray-500 font-medium">{{ t('common.sortLabel') }}</span>
    <div class="relative">
      <button
      ...
      <div v-if="showSortDropdown"
        class="absolute top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl py-1 z-30 min-w-[140px]"
